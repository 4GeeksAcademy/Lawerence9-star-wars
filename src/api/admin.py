...
from .models import db, Users, Followers, Comments, Medias, Posts, CharacterFavourites, PlanetFavourites, Characters, Planets
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(PlanetFavourites, db.session))
